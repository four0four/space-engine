...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Thu Apr 26 10:31:04 2012
# Project:  devtest.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt/mkspecs/linux-g++ CONFIG+=debug CONFIG+=declarative_debug -o Makefile devtest.pro
#############################################################################
